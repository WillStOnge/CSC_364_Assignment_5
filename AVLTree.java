public class AVLTree<E extends Comparable<E>> extends BST<E> {
    ...
    private int size(AVLTreeNode<E> node) {
    	if(node == null)
    		return 0;
    	return 1 + size((AVLTreeNode<E>) node.left) + size((AVLTreeNode<E>) node.right);
    }
    ...
    {
    	AVLTreeNode<E> A = (AVLTreeNode<E>) root.left, B = (AVLTreeNode<E>) root.right;
    	if(A == null && k == 1)
    		return root.element;
    	if(A == null && k == 2)
    		return B.element;
    ...
    protected static class AVLTreeNode<E> extends BST.TreeNode<E> {
        protected int height = 0, size = 0; // New data field
