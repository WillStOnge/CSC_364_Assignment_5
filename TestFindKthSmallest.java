...
public class TestFindKthSmallest {
    public static void main(String[] args) {
        ...
        System.out.printf("Creating AVL tree with %,d elements.\n", treeElements.length);
        ...
        System.out.printf("Starting tests using iterators.\n", NUM_TESTS);
        ...
        System.out.printf("Starting %,d tests using find method.\n", NUM_TESTS);
